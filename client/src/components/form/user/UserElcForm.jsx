...
export const UserElcForm = ({ item }) => {
    ...
    const {
        ...
        mode: "onChange",
        defaultValues: { elc: item.elc },
    });

    useEffect(() => {
        reset({ elc: item.elc }, { keepDirty: false });
    }, [item.elc]);
                ...
                <Box display={"flex"}>
                    ...
                    >
                        ...
                        <OutlinedInput
                            ...
                            id={`filled-adornment-amount-${item.id}-elc`}
                        />
                        <FormHelperText>
                            {(errors?.["elc"] && errors?.["elc"]?.message) ||
                                ""}
                        </FormHelperText>
                    </FormControl>
                </Box>
