                ...
                <Box display={"flex"}>
                    <BreadcrumbsComponent
                        ...
                        options={[
                            ...
                            { name: t("pages.account.credit.statement") },
                        ]}
                        sx={{
                            display: "inline-flex",
...
function Inner() {
    ...
    if (!data || !data?.statementData || data?.statementData?.length === 0)
        return <Empty />;
    ...
    return (
        ...
        >
            {data.statementData.map((credit, i) => (
                <StatementCreditItem i={i} key={credit.id} credit={credit} />
            ))}
        </Box>
    );
}
