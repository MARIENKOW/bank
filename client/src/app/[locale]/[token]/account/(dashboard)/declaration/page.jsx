                ...
                <Box display={"flex"}>
                    <BreadcrumbsComponent
                        ...
                        options={[
                            ...
                            { name: t("pages.account.declaration.name") },
                        ]}
                        sx={{
                            display: "inline-flex",
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <Box gap={1} flex={1} display={"flex"}>
                                        <Controller
                                            control={control}
                                            name={`jewels.currencies[${index}].currency`}
                                            rules={{
                                                required: t("form.required"),
                                            }}
                                            render={({
                                        ...
                                        <Box flex={1}>
                                            <Controller
                                                control={control}
                                                name={`jewels.currencies[${index}].sum`}
                                                rules={{
                                                    required:
                                                        t("form.required"),
                                                    pattern: {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <OutlinedInput
                                                                ...
                                                                type="number"
                                                                id={`filled-adornment-amount-sum-jewels-${field.id}`}
                                                                value={value}
                                                                onChange={({
                                                                    target,
                                                                }) => {
