...
import { ADMIN_USER_INSURANCE_ROUTE } from "../../../../../../../configs/routerLinks";
...
export default function InsuranceAccordion({ item, user }) {
    ...
    const onSubmit = async (data) => {
        try {
            await insurance.update({ ...data, id: item?.id });
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <Box display={"flex"} flexDirection={"column"} gap={1}>
                            ...
                            >
                                ...
                                >
                                    {user
                                        ? t("pages.account.insurance.info")
                                        : "Детальнее"}
                                </Button>
                            </Link>
                        </Box>
